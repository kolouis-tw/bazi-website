...
function deployZeabur() {
  const zshCommand = [
    ...
    '/opt/homebrew/bin/npx -y zeabur@latest deploy --project-id 6a008755e6a21fff4d962fee --service-id 6a0088674a961c814e9ee899 --environment-id 6a008755e5ed304c1d845a06 --interactive=false --json'
  ].join(" ");
